...
var _fnMt = __webpack_require__(/*! fn-mt */ "./node_modules/fn-mt/dist/index.js");
...
/***/ "./node_modules/fn-mt/dist/index.js":
/*!******************************************!*\
  !*** ./node_modules/fn-mt/dist/index.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./node_modules./next/dist/build/webpack/loaders./next-client-pages-loader.js?page=%2F&absolutePagePath=E%3A%5Cstudy%5Creact-ratio-inputs%5Cexamples%5Cbasic%5Cpages%5Cindex.js!./":
/*!************************************************************************************************************************************************************************************!*\
  !*** ./node_modules./next/dist/build/webpack/loaders./next-client-pages-loader.js?page=%2F&absolutePagePath=E%3A%5Cstudy%5Creact-ratio-inputs%5Cexamples%5Cbasic%5Cpages%5Cindex.js ***!
  \************************************************************************************************************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/react-ratio-inputs/dist/DefaultContainer.js":
/*!******************************************************************!*\
  !*** ./node_modules/react-ratio-inputs/dist/DefaultContainer.js ***!
  \******************************************************************/
/*! no static exports found */
...
var DefaultContainer = react_1.forwardRef(function (props, ref) {
    var style = props.style, items = props.items, labels = props.labels, controls = props.controls;
    // @ts-ignore
    return React.createElement("div", { ref: ref, style: __assign({ position: 'relative', userSelect: 'none' }, style), onSelect: function () { return false; } },
        React.createElement("div", { style: { position: 'relative', height: 32 } }, items),
        controls,
...
/***/ "./node_modules/react-ratio-inputs/dist/DefaultControl.js":
/*!****************************************************************!*\
  !*** ./node_modules/react-ratio-inputs/dist/DefaultControl.js ***!
  \****************************************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var react_1 = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var width = 14, unit = 'px', defaultColor = 'gray', hoverColor = 'red', height = 10;
var DefaultControl = function (_a) {
    var offset = _a.offset, onChange = _a.onChange, goUp = _a.goUp, meta = _a.meta;
    var _b = react_1.useState(false), dragging = _b[0], setDragging = _b[1];
    var _c = react_1.useState(-1), dragOffset = _c[0], setDragOffset = _c[1];
    var refEl = react_1.useRef(), refOffset = react_1.useRef(offset);
    react_1.useEffect(function () {
        refOffset.current = offset;
    }, [offset]);
    react_1.useEffect(function () {
        return registerDrag(refEl, refOffset, function (rawOffset, flush) {
            var min = meta.minEx, max = meta.max;
            // console.log({ min, max })
            var newOffset = rawOffset < min
                ? min
                : rawOffset > max
                    ? max
                    : rawOffset;
    ...
    return (React.createElement("div", { draggable: "false", onDragStart: function () { return false; }, style: {
            position: 'absolute',
            width: 0,
            height: 0,
...
exports["default"] = DefaultControl;
function registerDrag(refEl, offsetRef, onChange, setDragging) {
    var dragging = false, curX = 0, curOffset = 0, newOffset = 0;
...
/***/ "./node_modules/react-ratio-inputs/dist/DefaultControls.js":
/*!*****************************************************************!*\
  !*** ./node_modules/react-ratio-inputs/dist/DefaultControls.js ***!
  \*****************************************************************/
/*! no static exports found */
...
exports.__esModule = true;
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var DefaultControl_1 = __webpack_require__(/*! ./DefaultControl */ "./node_modules/react-ratio-inputs/dist/DefaultControl.js");
var DefaultControls = function (props) {
    var max = props.max, min = props.min, ratios = props.ratios, width = props.width, toFixed = props.toFixed, onChange = props.onChange;
    if (!width)
        return null;
    var controls = getControls(width, max, ratios, min), tmax = max;
    return (React.createElement("div", { style: { position: 'relative', height: 10 } }, controls.map(function (x, i) {
        var offset = x.offset;
        if (ratios[i].value === 0 && ratios[i + 1].value === 0)
            return null;
        return (React.createElement(DefaultControl_1["default"], { key: i, offset: offset, goUp: i !== 0 && ratios[i].value === 0, onChange: function (newOffset, flush) {
                var min = x.min, max = x.max, minValue = x.minValue, maxValue = x.maxValue;
                var newRatios = __spreadArrays(ratios);
                var sum = ratios[i].value + ratios[i + 1].value;
                if (newOffset < min) {
                    newRatios[i] = __assign(__assign({}, ratios[i]), { value: minValue });
                }
                else if (newOffset > max) {
                    newRatios[i] = __assign(__assign({}, ratios[i]), { value: maxValue });
                }
                else {
                    newRatios[i] = __assign(__assign({}, ratios[i]), { value: Number.parseFloat(((newOffset - min) / width * tmax).toFixed(toFixed || 0)) });
                }
                newRatios[i + 1] = __assign(__assign({}, ratios[i + 1]), { value: sum - newRatios[i].value });
                return onChange(newRatios, flush);
            }, meta: x }));
    })));
};
var MemDefaultControls = React.memo(DefaultControls, function (prevProps, nextProps) {
    var rtn = ["ratios", "width"].every(function (k) { return prevProps[k] === nextProps[k]; });
    return rtn;
});
exports["default"] = MemDefaultControls;
function getControls(width, tmax, ratios, tmin) {
    var metas = new Array(ratios.length - 1), left = 0, sum = 0;
    for (var i = 0; i < metas.length; i++) {
        var value = ratios[i].value;
        var twidth = width * value / tmax;
        metas[i] = {
            min: left,
            max: width,
            minValue: sum,
...
/***/ "./node_modules/react-ratio-inputs/dist/DefaultItem.js":
/*!*************************************************************!*\
  !*** ./node_modules/react-ratio-inputs/dist/DefaultItem.js ***!
  \*************************************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var DefaultItem = function (props) {
    var offset = props.offset, length = props.length, _a = props.style, style = _a === void 0 ? {} : _a, _b = props.colorScheme, colorScheme = _b === void 0 ? {} : _b, text = props.text, title = props.title;
    // @ts-ignore
    var _c = colorScheme.backgroundColor, backgroundColor = _c === void 0 ? 'transparent' : _c, _d = colorScheme.color, color = _d === void 0 ? '#000' : _d;
    return React.createElement("div", { style: __assign({ position: 'absolute', bottom: 0, left: offset, width: length, backgroundColor: backgroundColor, lineHeight: '32px', color: color, textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden' }, style), title: title }, text);
};
...
/***/ "./node_modules/react-ratio-inputs/dist/RatioInputs.js":
/*!*************************************************************!*\
  !*** ./node_modules/react-ratio-inputs/dist/RatioInputs.js ***!
  \*************************************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var react_1 = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var DefaultContainer_1 = __webpack_require__(/*! ./DefaultContainer */ "./node_modules/react-ratio-inputs/dist/DefaultContainer.js");
var DefaultControls_1 = __webpack_require__(/*! ./DefaultControls */ "./node_modules/react-ratio-inputs/dist/DefaultControls.js");
var DefaultItem_1 = __webpack_require__(/*! ./DefaultItem */ "./node_modules/react-ratio-inputs/dist/DefaultItem.js");
var shuffle = __webpack_require__(/*! fast-shuffle */ "./node_modules/fast-shuffle/dist/index.js")["default"];
var useMeasure = __webpack_require__(/*! react-use/lib/useMeasure */ "./node_modules/react-use/lib/useMeasure.js")["default"];
var RatioInputs = function (_a) {
    var ratios = _a.ratios, max = _a.max, min = _a.min, onChange = _a.onChange, propForUnused = _a.propForUnused, _b = _a.ControlsComponent, ControlsComponent = _b === void 0 ? DefaultControls_1["default"] : _b, _c = _a.toFixed, toFixed = _c === void 0 ? 0 : _c, _d = _a.ItemComponent, ItemComponent = _d === void 0 ? DefaultItem_1.DefaultItem : _d, _e = _a.ContainerComponent, ContainerComponent = _e === void 0 ? DefaultContainer_1["default"] : _e, _f = _a.nameForUnused, nameForUnused = _f === void 0 ? '未使用' : _f, _g = _a.toText, toText = _g === void 0 ? function (_a) {
        var name = _a.name, value = _a.value;
        return name + "(" + value + ")";
    } : _g, _h = _a.toTitle, toTitle = _h === void 0 ? function (_a) {
        var name = _a.name, value = _a.value;
        return name + "(" + value + ")";
    } : _h, _j = _a.hue2color, hue2color = _j === void 0 ? function (hue) { return "hsl(" + hue + ", 20%, 10%)"; } : _j, _k = _a.hue2backgroundColor, hue2backgroundColor = _k === void 0 ? function (hue) { return "hsl(" + hue + ", 80%, 90%)"; } : _k;
    var _l = useMeasure(), ref = _l[0], width = _l[1].width;
    var _m = react_1.useState(0), tmax = _m[0], setTmax = _m[1];
    var colors = react_1.useState(getColors(ratios.length + 1))[0];
    var _o = react_1.useState(false), hasUnused = _o[0], setHasUnused = _o[1];
    var _p = react_1.useState([]), tmpRatios = _p[0], setTmpRatios = _p[1];
    var _q = react_1.useState([]), tratios = _q[0], setTratios = _q[1];
    react_1.useEffect(function () {
        var ratios1 = ratios;
        var sum = ratios1.reduce(function (cur, _a) {
            var value = _a.value;
            return cur + value;
        }, 0);
        var tmax = max ? max : sum;
        if (tmax < sum)
            throw 'max less than sum of ratios';
        setTmax(tmax);
        if (min !== undefined && min >= tmax)
            throw 'min larger than max or sum';
        var minCauseUnused = min !== undefined
            ? min > 0
            : false;
        var maxCauseUsed = tmax > sum;
        var hasUnused = minCauseUnused || maxCauseUsed;
        setHasUnused(hasUnused);
    }, []);
    var widthRef = react_1.useRef(width);
    react_1.useEffect(function () {
    ...
    react_1.useEffect(function () {
        ...
        var unUsedRatioItem = {
            name: nameForUnused,
            value: tmax - ratios1.reduce(function (cur, _a) {
                var value = _a.value;
                return cur + value;
            }, 0),
            props: propForUnused
        };
        var tratios = hasUnused
            ? __spreadArrays(ratios, [unUsedRatioItem]) : ratios;
        setTratios(tratios);
    }, [ratios, hasUnused]);
    var left = 0, items = tmpRatios.length
        ? tmpRatios
        : tratios;
    return (React.createElement(ContainerComponent, { ref: ref, items: items.map(function (item, i) {
            var value = item.value, name = item.name, props = item.props;
            if (!width)
                return null;
            var tleft = left, twidth = width * value / tmax;
            left += twidth;
            return (React.createElement(ItemComponent, __assign({}, props, { name: name, key: i, value: value, text: toText(item), title: toTitle(item), offset: tleft, length: twidth, colorScheme: colors[i] })));
        }), controls: (!onChange || !width) ? null : (React.createElement(ControlsComponent, { width: width, max: tmax, min: min, toFixed: toFixed, ratios: tratios, onChange: function (ratios, flush) {
                if (!flush) {
    ...
    function getColors(num) {
        var arr = new Array(num), curHue = 0, hueOffset = Math.floor(360 / num) || 1;
        for (var i = 0; i < num; i++) {
...
exports["default"] = RatioInputs;


/***/ }),

/***/ "./node_modules/react-ratio-inputs/dist/index.js":
/*!*******************************************************!*\
  !*** ./node_modules/react-ratio-inputs/dist/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
exports.__esModule = true;
var RatioInputs_1 = __webpack_require__(/*! ./RatioInputs */ "./node_modules/react-ratio-inputs/dist/RatioInputs.js");
exports["default"] = RatioInputs_1["default"];
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/react-use/node_modules/tslib/tslib.es6.js");
var react_1 = tslib_1.__importDefault(__webpack_require__(/*! fast-deep-equal/react */ "./node_modules/fast-deep-equal/react.js"));
